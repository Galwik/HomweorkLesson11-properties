...
public enum ProperiesStore {
    ...
    private ProperiesStore(String key) {
        this.propertyKey = key;
        this.value = this.retreiveValue(key);
    }

    private String retreiveValue(String key) {
    ...
    public String getValue() {
        return this.retreiveValue(this.propertyKey);
    }

    public int getIntValue() {
        return Integer.parseInt(this.retreiveValue(this.propertyKey));
    }

...
public class BrowserEnvironment {
    ...
    public BrowserEnvironment() {
        ...
        this.browserName = ProperiesStore.BROWSER.isSpecified() ? ProperiesStore.BROWSER.getValue() : this.browserName;
        this.initBrowserSettings();
    }

    private void initBrowserSettings() {
        this.webElementTimeOut = ProperiesStore.BROWSER_WEBELEMENT_TIMEOUT.isSpecified() ? ProperiesStore.BROWSER_WEBELEMENT_TIMEOUT.getIntValue() : this.webElementTimeOut;
        this.headlessBrowser = ProperiesStore.BROWSER_HEADLESS.getBoolean();
    }
